    ...
    extend: {
      ...
      colors: {
        ...
        vault: {
          ...
          slate: "hsl(var(--vault-slate))",
          emerald: "hsl(var(--vault-emerald))",
          "emerald-light": "hsl(var(--vault-emerald-light))",
          "emerald-dark": "hsl(var(--vault-emerald-dark))",
          amber: "hsl(var(--vault-amber))",
          "amber-light": "hsl(var(--vault-amber-light))",
          red: "hsl(var(--vault-red))",
          "red-light": "hsl(var(--vault-red-light))",
