...
export default function EntryView() {
  ...
  const properties = Object.keys(grouped);
  const [expandedProperty, setExpandedProperty] = useState<string | null>(properties[0] || null);
  ...
  return (
    <div className="space-y-4 max-w-7xl">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">Tenant-by-tenant data for manual AppFolio entry.</p>
      </div>
